...
export class DrawerListComponent implements OnInit{
  ...
  constructor(private selectedItemService: SelectedItemService, private sidenavToggleService: SidenavToggleService) {
  }
  ...
  onSelectionChange() {
    this.selectedItemService.setSelectedItem(this.selectionList.selectedOptions.selected[0].value);
